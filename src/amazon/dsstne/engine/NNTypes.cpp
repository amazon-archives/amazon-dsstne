...
static std::map<TrainingMode, string> sTrainingModeMap = { { TrainingMode::SGD, "SGD" }, { TrainingMode::Momentum,
    "Momentum" }, { TrainingMode::AdaGrad, "AdaGrad" }, { TrainingMode::Nesterov, "Nesterov" }, { TrainingMode::RMSProp,
    "RMSProp" }, { TrainingMode::AdaDelta, "AdaDelta" }, { TrainingMode::Adam, "Adam" } };
...
static std::map<ErrorFunction, string> sErrorFunctionMap = { { ErrorFunction::L1, "L1" }, { ErrorFunction::L2, "L2" }, {
    ErrorFunction::CrossEntropy, "CrossEntropy" }, { ErrorFunction::ScaledMarginalCrossEntropy,
    "ScaledMarginalCrossEntropy" }, { ErrorFunction::Hinge, "Hinge" }, { ErrorFunction::L2Hinge, "L2Hinge" }, };
...
static std::map<Activation, string> sActivationMap = { { Activation::Sigmoid, "Sigmoid" }, { Activation::Tanh, "Tanh" },
    { Activation::Linear, "Linear" }, { Activation::ParametricRectifiedLinear, "ParametricRectifiedLinear" }, {
        Activation::SoftSign, "SoftSign" }, { Activation::SoftPlus, "SoftPlus" }, { Activation::SoftMax, "SoftMax" }, {
        Activation::RELUMax, "RELUMax" }, { Activation::LinearMax, "LinearMax" }, { Activation::RectifiedLinear,
        "RectifiedLinear" }, { Activation::LeakyRectifiedLinear, "LeakyRectifiedLinear" }, {
        Activation::ExponentialLinear, "ExponentialLinear" }, { Activation::ScaledExponentialLinear,
...
static std::map<WeightInitialization, string> sWeightInitializationMap = { { WeightInitialization::Xavier, "Xavier" }, {
    WeightInitialization::CaffeXavier, "CaffeXavier" }, { WeightInitialization::Gaussian, "Gaussian" }, {
    WeightInitialization::Uniform, "Uniform" }, { WeightInitialization::UnitBall, "UnitBall" }, {
    WeightInitialization::Constant, "Constant" }, { WeightInitialization::SELU, "SELU" } };
...
static std::map<PoolingFunction, string> sPoolingFunctionMap = { { PoolingFunction::None, "None" }, {
    PoolingFunction::Max, "Max" }, { PoolingFunction::Average, "Average" }, { PoolingFunction::Maxout, "Maxout" }, {
    PoolingFunction::DotProduct, "DotProduct" }, { PoolingFunction::Cosine, "Cosine" }, { PoolingFunction::Stochastic,
    "Stochastic" }, { PoolingFunction::LCN, "LocalContrastNormalization" }, { PoolingFunction::LRN,
    "LocalResponseNormalization" }, { PoolingFunction::GlobalTemporal, "GlobalTemporal" } };
...
static std::map<NNDataSetEnums::Kind, string> sKindMap = { { NNDataSetEnums::Numeric, "Numeric" }, {
    NNDataSetEnums::Image, "Image" }, { NNDataSetEnums::Audio, "Audio" } };
...
static std::map<NNDataSetEnums::Attributes, string> sAttributesMap = { { NNDataSetEnums::Sparse, "Sparse" }, {
    NNDataSetEnums::Boolean, "Boolean" }, { NNDataSetEnums::Compressed, "Compressed" }, { NNDataSetEnums::Recurrent,
    "Recurrent" }, { NNDataSetEnums::Mutable, "Mutable" }, { NNDataSetEnums::Attributes::SparseIgnoreZero,
    "SparseIgnoreZero" }, { NNDataSetEnums::Attributes::Indexed, "Indexed" }, };
...
static std::map<NNDataSetEnums::Sharding, string> sShardingMap = { { NNDataSetEnums::None, "None" }, {
    NNDataSetEnums::Model, "Model" }, { NNDataSetEnums::Data, "Data" } };
...
static std::map<NNDataSetEnums::DataType, string> sDataTypeMap = { { NNDataSetEnums::UInt, "UInt" }, {
    NNDataSetEnums::Int, "Int" }, { NNDataSetEnums::LLInt, "LLInt" }, { NNDataSetEnums::ULLInt, "ULLInt" }, {
    NNDataSetEnums::Float, "Float" }, { NNDataSetEnums::Double, "Double" }, { NNDataSetEnums::RGB8, "RGB8" }, {
    NNDataSetEnums::RGB16, "RGB16" }, { NNDataSetEnums::UChar, "UChar" }, { NNDataSetEnums::Char, "Char" } };
...
template<typename T> vector<tuple<uint64_t, uint64_t> > NNDataSet<T>::getMemoryUsage()
{
  ...
  MPI_Allgather(MPI_IN_PLACE, 0, MPI_DATATYPE_NULL, vResult.data(), sizeof(tuple<uint64_t, uint64_t> ), MPI_BYTE,
                MPI_COMM_WORLD);
  return vResult;
}
                                             ...
                                             uint32_t examples, const NNLayer &layer)
{
  ...
  tie(_width, _height, _length, NULL) = layer.GetDimensions();
  ...
  if ((attributes & NNDataSetEnums::Attributes::Sparse) != 1)
  {
    ...
    _vIndex.resize(stride * _examples);
      ...
      _pbSparseData()
{
  ...
  if (getGpu()._id == 0)
  {
    ...
    try
    {
      ...
      if (nameAtt.isNull())
      {
        throw NcException("NcException", "NNDataSet::NNDataSet: No dataset name supplied in NetCDF input file " + fname,
                          __FILE__, __LINE__);
      }
      ...
      {
        throw NcException("NcException", "NNDataSet::NNDataSet: No datatype supplied in NetCDF input file " + fname,
                          __FILE__, __LINE__);
      }
      int dataType;
      ...
      {
        throw NcException("NcException", "NNDataSet::NNDataSet: No attributes supplied in NetCDF input file " + fname,
                          __FILE__, __LINE__);
      }
      ...
      if (examplesDim.isNull())
      {
        throw NcException("NcException",
                          "NNDataSet::NNDataSet: No examples count supplied in NetCDF input file " + fname, __FILE__,
                          __LINE__);
      }
      ...
      {
        throw NcException("NcException",
                          "NNDataSet::NNDataSet: Zero-valued Examples count in NetCDF input file " + fname, __FILE__,
                          __LINE__);
      }
      ...
      {
        throw NcException("NcException",
                          "NNDataSet::NNDataSet: No dimension count supplied in NetCDF input file " + fname, __FILE__,
                          __LINE__);
      }
      ...
      if ((_dimensions < 1) || (_dimensions > 3))
      {
        throw NcException(
            "NcException",
            "NNDataSet::NNDataSet: Invalid dimension count (" + to_string(_dimensions)
                + ") supplied in NetCDF input file " + fname,
            __FILE__, __LINE__);
      }
      ...
      {
        throw NcException("NcException",
                          "NNDataSet::NNDataSet: No datapoint width supplied in NetCDF input file " + fname, __FILE__,
                          __LINE__);
      }
      ...
      if (_dimensions > 1)
      {
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: No datapoint height supplied in NetCDF input file " + fname,
                            __FILE__, __LINE__);
        }
      ...
      if (_dimensions > 2)
      {
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: No datapoint length supplied in NetCDF input file " + fname,
                            __FILE__, __LINE__);
        }
        lengthAtt.getValues(&_length);
      } else
        _length = 1;
      cout << "NNDataSet<T>::NNDataSet: " << _dimensions << "-dimensional data comprised of (" << _width << ", "
           << _height << ", " << _length << ") datapoints." << endl;

      // Make sure all dimensions are at least 1
      if ((_width == 0) || (_height == 0) || (_length == 0))
      {
        throw NcException("NcException",
                          "NNDataSet::NNDataSet: Invalid dataset dimensions in NetCDF input file " + fname, __FILE__,
                          __LINE__);
      }
      ...
      if (_attributes & NNDataSetEnums::Sparse)
      {
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: No sparse data dimensions supplied in NetCDF input file " + fname,
                            __FILE__, __LINE__);
        }
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: Sparse data set with no actual data in NetCDF input file " + fname,
                            __FILE__, __LINE__);
        }
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: No sparse offset start supplied in NetCDF input file " + fname,
                            __FILE__, __LINE__);
        }
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: No sparse data end supplied in NetCDF input file " + fname, __FILE__,
                            __LINE__);
        }
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: No sparse data indices supplied in NetCDF input file " + fname,
                            __FILE__, __LINE__);
        }
        ...
        if (!(_attributes & NNDataSetEnums::Boolean))
        {
          ...
          {
            throw NcException("NcException",
                              "NNDataSet::NNDataSet: No sparse data located in NetCDF input file " + fname, __FILE__,
                              __LINE__);
          }
        ...
        if (_attributes & NNDataSetEnums::Weighted)
        {
          ...
          {
            throw NcException("NcException",
                              "NNDataSet::NNDataSet: No sparse weights located in NetCDF input file " + fname, __FILE__,
                              __LINE__);
          }
      ...
      } else
      {
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: No data dimensions located in NetCDF input file " + fname, __FILE__,
                            __LINE__);
        }
        vname = "data" + nstring;
      ...
      if (_attributes & NNDataSetEnums::Indexed)
      {
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::NNDataSet: No indexed data located in NetCDF input file " + fname, __FILE__,
                            __LINE__);
        }
...
template<typename T> bool NNDataSet<T>::CalculateSparseDatapointCounts()
{
  if (_attributes & NNDataSetEnums::Sparse)
  {
    ...
    for (size_t i = 0; i < N; i++)
    {
      ...
      {
        size_t size2 = std::min(_vSparseMaxDatapointCount[i] * batch,
                                batch + (_vSparseMaxDatapointCount[i] - 1) * _vSparseMultiDatapointCount[i]);
  ...
  } else
  {
    ...
    {
      printf(
          "NNDataSet::CalculateSparseDatapointCounts: Attempt to calculate sparse datapoint counts on non-sparse dataset %s.\n",
          _name.c_str());
    }
    return false;
  }
...
template<typename T> bool NNDataSet<T>::GenerateSparseTransposedMatrix(uint32_t batch, NNLayer* pLayer)
{
  ...
  if (offset > _sparseTransposedIndices)
  {
    ...
    printf(
        "NNDataSet::GenerateSparseTransposedMatrix: Allocating %lu bytes for sparse transposed weight gradient index matrix %s.\n",
    ...
    {
      printf(
          "NNDataSet::GenerateSparseTransposedMatrix: Allocating %lu bytes for sparse transposed weight gradient value matrix %s.\n",
...
template<typename T> bool NNDataSet<T>::UnShard()
{
  if (_sharding == NNDataSetEnums::Model)
  {
    if (_attributes & NNDataSetEnums::Sparse)
    {
      ...
      MPI_Reduce((getGpu()._id == 0) ? MPI_IN_PLACE : &datapoints, &datapoints, 1, MPI_UINT64_T, MPI_SUM, 0,
                 MPI_COMM_WORLD);
      MPI_Reduce((getGpu()._id == 0) ? MPI_IN_PLACE : vSparseCount.data(), vSparseCount.data(), _uniqueExamples,
...
template<typename T> bool NNDataSet<T>::SaveNetCDF(const string& fname)
{
  ...
  if (getGpu()._id == 0)
  {
    ...
    try
    {
      ...
      {
        throw NcException("NcException", "SaveNetCDF: Unable to write datasets attribute to NetCDF file " + fname,
                          __FILE__, __LINE__);
      }

      bool bResult = WriteNetCDF(nfc, fname, 0);
      if (!bResult)
        throw NcException("NcException", "SaveNetCDF: Unable to write dataset to NetCDF file " + fname, __FILE__,
                          __LINE__);
    } catch (NcException& e)
    {
      if (!bOpened)
...
template<typename T> bool NNDataSet<T>::WriteNetCDF(NcFile& nfc, const string& fname, const uint32_t n)
{
  ...
  try
  {
    if (getGpu()._id == 0)
    {
      ...
      if (nameAtt.isNull())
      {
        throw NcException("NcException", "NNDataSet::WriteNetCDF: Failed to write dataset name to NetCDF file " + fname,
                          __FILE__, __LINE__);
      }
      ...
      {
        throw NcException("NcException",
                          "NNDataSet::WriteNetCDF: Failed to write dataset attributes to NetCDF file " + fname,
                          __FILE__, __LINE__);
      }
      ...
      if (kindAtt.isNull())
      {
        throw NcException("NcException", "NNDataSet::WriteNetCDF: Failed to write dataset kind to NetCDF file " + fname,
                          __FILE__, __LINE__);
      }
      ...
      if (datatypeAtt.isNull())
      {
        throw NcException("NcException", "NNDataSet::WriteNetCDF: Failed to write dataset type to NetCDF file " + fname,
                          __FILE__, __LINE__);
      }
      ...
      {
        throw NcException("NcException",
                          "NNDataSet::WriteNetCDF: Failed to write dataset dimensions to NetCDF file " + fname,
                          __FILE__, __LINE__);
      }
      ...
      {
        throw NcException("NcException",
                          "NNDataSet::WriteNetCDF: Failed to write dataset width to NetCDF file " + fname, __FILE__,
                          __LINE__);
      }
      ...
      if (_dimensions > 1)
      {
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::WriteNetCDF: Failed to write dataset height to NetCDF file " + fname, __FILE__,
                            __LINE__);
        }
        ...
        if (_dimensions > 2)
        {
          ...
          {
            throw NcException("NcException",
                              "NNDataSet::WriteNetCDF: Failed to write dataset length to NetCDF file " + fname,
                              __FILE__, __LINE__);
          }
        }
      }
      ...
      if (uniqueExamplesDim.isNull())
      {
        throw NcException(
            "NcException",
            "NNDataSet::WriteNetCDF: Failed to write dataset unique example count to NetCDF file " + fname, __FILE__,
            __LINE__);
      }
      ...
      {
        throw NcException("NcException",
                          "NNDataSet::WriteNetCDF: Failed to write dataset example count to NetCDF file " + fname,
                          __FILE__, __LINE__);
      }
      ...
      if (_attributes & NNDataSetEnums::Sparse)
      {
        ...
        if (sparseDataDim.isNull())
        {
          throw NcException(
              "NcException",
              "NNDataSet::WriteNetCDF: Failed to write dataset sparse datapoint count to NetCDF file " + fname,
              __FILE__, __LINE__);
        }
        ...
        if (sparseStartVar.isNull())
        {
          throw NcException(
              "NcException",
              "NNDataSet::WriteNetCDF: Failed to write dataset sparse start variable to NetCDF file " + fname, __FILE__,
              __LINE__);
        }
        ...
        if (sparseEndVar.isNull())
        {
          throw NcException(
              "NcException",
              "NNDataSet::WriteNetCDF: Failed to write dataset sparse end variable to NetCDF file " + fname, __FILE__,
              __LINE__);
        }
        ...
        if (sparseIndexVar.isNull())
        {
          throw NcException(
              "NcException",
              "NNDataSet::WriteNetCDF: Failed to write dataset sparse index variable to NetCDF file " + fname, __FILE__,
              __LINE__);
        }
        ...
        if (!(_attributes & NNDataSetEnums::Boolean))
        {
          ...
          if (sparseDataVar.isNull())
          {
            throw NcException(
                "NcException",
                "NNDataSet::WriteNetCDF: Failed to write dataset sparse data variable to NetCDF file " + fname,
                __FILE__, __LINE__);
          }
        ...
        if (_attributes & NNDataSetEnums::Weighted)
        {
          ...
          {
            throw NcException("NcException",
                              "NNDataSet::NNDataSet: Failed to write sparse weights NetCDF file " + fname, __FILE__,
                              __LINE__);
          }
      ...
      if (_attributes & NNDataSetEnums::Indexed)
      {
        ...
        {
          throw NcException("NcException",
                            "NNDataSet::WriteNetCDF: Failed to create dataset index variable to NetCDF file " + fname,
                            __FILE__, __LINE__);
        }
...
vector<NNDataSetBase*> LoadNetCDF(const string& fname)
{
  ...
  if (getGpu()._id == 0)
  {
    ...
    try
    {
      ...
      if (dataSetsAtt.isNull())
      {
        throw NcException("NcException", "LoadNetCDF: No datasets count supplied in NetCDF input file " + fname,
                          __FILE__, __LINE__);
      }
      uint32_t datasets;
      ...
      for (uint32_t i = 0; i < datasets; i++)
      {
        ...
        {
          throw NcException("NcException",
                            "LoadNetCDF: No " + vname + " attribute located in NetCDF input file " + fname, __FILE__,
                            __LINE__);
        }
        uint32_t dataType;
        dataTypeAtt.getValues(&dataType);
